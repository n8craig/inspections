clean_fac_operator_names <- function(x) {
  x <- x %>% 
    mutate(
      ...
      fac_operator = replace(fac_operator, fac_operator == "Almance County Sheriff's Office", "Alamance County Sherrif's Office"),
      fac_operator = replace(fac_operator, fac_operator == "Boone County", "Boone County Sheriff's Office"),
      fac_operator = replace(fac_operator, fac_operator == "Bristol County", "Bristol County Sheriff's Office"),
      fac_operator = replace(fac_operator, fac_operator == "Sheriff of Calhoun County", "Calhoun County Sheriff's Department"),
      ...
      fac_operator = replace(fac_operator, fac_operator == "Providence County", "Central Falls Detention Facility Corporation"),
      
      
      fac_operator = replace(fac_operator, fac_operator == "Dorchester County Council", "Dorchester County Sheriff's Office"),
      fac_operator = replace(fac_operator, fac_operator == "Geauga County", "Geauga County Sheriff's Office"),
      
      
      fac_operator = replace(fac_operator, fac_operator == "Geauga County Sheriff's Department", "Geauga County Sheriff's Office"),
      ...
      fac_operator = replace(fac_operator, fac_operator == "Jackson Parish Sheriff's Department", "LaSalle Corrections"),
      ...
      fac_operator = replace(fac_operator, fac_operator == "Management Training Corporation (MTC)", "Management & Training Corporation (MTC)"),
      ...
      fac_operator = replace(fac_operator, fac_operator == "County of Strafford", "Strafford County Sheriff's Office"),
      fac_operator = replace(fac_operator, fac_operator == "Straffordd County Sheriff's Office", "Strafford County Sheriff's Office"),
